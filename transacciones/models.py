...
class Transaccion(models.Model):
    ...
    tipo_transaccion = models.CharField(max_length=5, choices=TIPO_CHOICES, blank=True, null=True)
    ...
    def __str__(self):
        return f"Venta del {self.fecha_transaccion} - Total: {self.total_transaccion}"
